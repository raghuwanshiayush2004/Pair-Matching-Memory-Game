...
window.onload = function() {
    $("#ol").html(`<center><div id="inst"><h3>Gameplay !</h3>Gameplay Directions<br/><br/><li>Match similar blocks by performing flips to create pairs.</li><li>To initiate a flip, simply click on a block.</li><li>If the clicked blocks do not match, a flip will return them to their original state.</li><p style="font-size:18px;">Click on a mode below to start playing the game.</p></div><button onclick="start(3, 4)">3 x 4</button> <button onclick="start(4, 4)" style="w">4 x 4</button><button onclick="start(4, 5)">4 x 5</button><button onclick="start(5, 6)">5 x 6</button><button onclick="start(6, 6)">6 x 6</button></center>`);
}
//Starting the game
function start(r,l) {
    //Timer and moves
